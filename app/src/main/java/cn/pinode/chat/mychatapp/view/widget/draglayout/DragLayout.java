...
public class DragLayout extends FrameLayout {
    ...
    private FrameLayout mMainContentMask;
...
//    private OnDragStatusListener mListener;
    private Set<OnDragStatusListener> dragStatusListeners = Collections.newSetFromMap(
        new WeakHashMap<OnDragStatusListener, Boolean>());


    public void setDragStateListener(OnDragStatusListener listener) {
        dragStatusListeners.add(listener);
...
*/
    ...
    private void dispatchDragEvent(int newLeft) {
        ...
        for (OnDragStatusListener ll: dragStatusListeners){
            ll.onDraging(percent);
            mMainContentMask.setAlpha(percent*0.6f);
        }
        ...
        if (mStatus != lastStatus) {
            ...
            if (mStatus == Status.CLOSE) {
                ...
                for (OnDragStatusListener ll: dragStatusListeners){
                    ll.onOpen();
                    mMainContentMask.requestDisallowInterceptTouchEvent(true);
                }
            }
        }
...
*/
    ...
    protected void onFinishInflate() {
         ...
         * 得到主main布局
         */
        mMainContent = (MainContentLayout) getChildAt(1);
